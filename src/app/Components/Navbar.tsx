...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { 
      ...
      href: '/solutions',
      dropdown: [
        { name: 'Asset & Equipment Management', href: '/Asset-Equipment-Management', description: 'Optimize assets from day one to decommission' },
        { name: 'Workforce Management', href: '/Workforce-Management', description: 'Intelligent scheduling & analytics' },
        { name: 'Customer Experience', href: '/Customer-Experience', description: 'Self-service & proactive communications' },
        { name: 'Business Operations', href: '/Business-Operations', description: 'Streamline back-office processes' },
        { name: 'More...', href: '/Solutions', description: 'See all solutions' },
      ]
    },
    { 
      name: 'Industries', 
