...
export default function Home() {
  ...
  const [orbPositions, setOrbPositions] = useState<Array<{top: string, left: string, width: string, height: string, animation: string, delay: string}>>([]);
  const [particlePositions, setParticlePositions] = useState<Array<{top: string, left: string, delay: string, duration: string, opacity: number}>>([]);
