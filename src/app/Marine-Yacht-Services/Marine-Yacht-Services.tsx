      ...
      <section className="py-20 px-4 bg-gradient-to-b from-gray-900 to-black">
        <div className="container mx-auto max-w-6xl text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-10">
            Deliver luxury-grade reliability on every voyage with Fielduo's Marine & Yacht Services solution. Manage crew, dock schedules, and maintenance workflows seamlessly—whether for private yachts or commercial vessels.
          </p>
