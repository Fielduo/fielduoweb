...
const IndustriesPage = () => {
  ...
  const industries = [
    ...
    { 
      ...
      description: 'Ensure on-time, compliant, and safe aircraft operations with specialized maintenance solutions.', 
      icon: '✈️',
      link: '/Aviation-Aircraft-Maintenance'
    },
    { 
      title: 'Marine & Yacht Services', 
      description: 'Deliver luxury-grade reliability on every voyage with crew and maintenance management.', 
      icon: '⛵',
      link: '/Marine-Yacht-Services'
    },
    { 
      title: 'Agriculture & Farm Equipment', 
      description: 'Transform farm operations with precision maintenance and real-time diagnostics.', 
      icon: '🚜',
      link: '/Agriculture-Farm-Equipment'
    },
    { 
      title: 'Mining Equipment Services', 
      description: 'Ensure continuous extraction and haulage with robust heavy-duty machinery management.', 
      icon: '⛏️',
      link: '/Mining-Equipment-Services'
    },
    { 
      title: 'Smart Cities & Urban Infrastructure', 
      description: 'Power the future of urban living with critical infrastructure maintenance solutions.', 
      icon: '🏙️',
      link: '/Smart-Cities-Urban-Infrastructure'
    },
    { 
      title: 'Wind Turbine & Renewable Energy Maintenance', 
      description: 'Keep renewable assets generating at maximum efficiency with specialized maintenance.', 
      icon: '🌪️',
      link: '/Wind-Turbine-Renewable-Energy-Maintenance'
    },
    { 
      title: 'Banking & Financial Services', 
      description: 'Deliver bullet-proof uptime for ATM networks and payment infrastructure.', 
      icon: '🏦',
      link: '/Banking-Financial-Services'
    },
    { 
      title: 'Transportation & Logistics', 
      description: 'Optimize fleet readiness and warehouse operations for modern supply chains.', 
      icon: '🚛',
      link: '/Transportation-Logistics'
    },
    { 
      title: 'Retail Point-of-Sale (POS) Systems', 
      description: 'Deliver frictionless shopping and secure transactions with POS management.', 
      icon: '🛒',
      link: '/Retail-Point-of-Sale-Systems'
    },
    { 
      title: 'Government & Public Sector', 
      description: 'Support civic infrastructure and emergency response with public sector FSM.', 
      icon: '🏛️',
      link: '/Government-Public-Sector'
    },
    { 
      title: 'Specialized Logistics Services', 
      description: 'Enable end-to-end supply chain excellence with 3PL and advanced logistics capabilities.', 
      icon: '📦',
      link: '/Specialized-Logistics-Services'
    },
    { 
      title: 'Advanced Manufacturing Services', 
      description: 'Empower Industry 4.0 transformation with robotics, IoT, and predictive analytics.', 
      icon: '🏭',
      link: '/Advanced-Manufacturing-Services'
    },
  ];
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-gray-900 to-black">
        <div className="container mx-auto max-w-6xl text-center">
          <div className="inline-flex items-center bg-blue-900 bg-opacity-50 px-4 py-2 rounded-full mb-8">
            <span className="text-blue-300 text-sm font-semibold">50+ Industries Served</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-10">
            Fielduo powers 50+ specialized trades with tailored solutions designed for your unique business needs.
          </p>
