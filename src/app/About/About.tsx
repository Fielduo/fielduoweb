...
import Mani from '../../../public/Mani.jpeg'; // Added import for Mani's image
import AOS from 'aos';
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          {activeTeamTab === 'leadership' && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              {/* Kiruthiga */}
              <div className="group bg-gray-900 bg-opacity-70 backdrop-blur-sm rounded-2xl p-10 border border-gray-800 hover:border-blue-500 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-blue-500/20" data-aos="fade-up" data-aos-delay="500">
                <div className="relative w-32 h-32 rounded-full mx-auto mb-8 group-hover:scale-105 transition-transform overflow-hidden">
                  <img 
                    src={Kiruthiga.src}
              ...
              {/* Abavanan Mani - New team member */}
              <div className="group bg-gray-900 bg-opacity-70 backdrop-blur-sm rounded-2xl p-10 border border-gray-800 hover:border-blue-500 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-blue-500/20" data-aos="fade-left" data-aos-delay="600">
                <div className="relative w-32 h-32 rounded-full mx-auto mb-8 group-hover:scale-105 transition-transform overflow-hidden">
                  <img 
                    src={Mani.src}
                    alt="Abavanan Mani - CGO" 
                    className="w-full h-full object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                </div>
                <h3 className="text-3xl font-bold mb-2">Abavanan Mani</h3>
                <p className="text-blue-400 mb-6 text-lg">CGO - Chief Growth Officer</p>
                <p className="text-gray-300 mb-8 leading-relaxed">
                  Strategic leader with a proven track record in driving business growth and market expansion.
                </p>
                <button className="group flex items-center justify-center text-blue-400 hover:text-blue-300 font-medium mx-auto">
                  Learn more
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform" viewBox="0 0 20 20" fill="currentColor">
